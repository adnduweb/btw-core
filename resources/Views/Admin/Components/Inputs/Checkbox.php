...
<div class="flex items-center <?= $class; ?>">
    <input <?= $xInput ?> name="<?= $nameNew ?>" id="<?= $nameNew; ?>" type="checkbox" class="checkbox checkbox-primary rounded ml-1 w-5 h-5 ease-linear transition-all duration-150 border border-gray-200 focus:bg-white focus:border-gray-500" value="<?= $value; ?>" <?php if ($checkedNew) : ?> checked <?php endif ?> <?= $xOnClick; ?> <?= $xChange; ?> >
