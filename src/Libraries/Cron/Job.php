...
namespace Btw\Core\Libraries\Cron;

use CodeIgniter\Events\Events;
use CodeIgniter\I18n\Time;
use Btw\Core\Exceptions\CronJobException;
use Btw\Core\Libraries\Cron\Traits\FrequenciesTrait;
use Config\Services;
...
class Job
{
    ...
    public function lastRun()
    {
        ...
        if ($config->logSavingMethod == 'database') {
            $logModel = new \Btw\Core\Models\CronJobLogModel();
