...
class Encrypt {
       ...
       * @var string
       */
      private static $key = "k2ZCf2pRR45XrHzhcH4p7FTS6qt25d79";
       ...
       * @var array
       */
      protected $_modes = array('mcrypt' => array(
                  'cbc' => 'cbc',
                  'ecb' => 'ecb',
                  'ofb' => 'nofb',
                  'ofb8' => 'ofb',
      ...
      public function initialize(array $params) {
            ...
            empty($params['key']) or self::$key = $params['key'];
      ...
      public function encrypt($data, array $params = null) {
            ...
            isset($params['key']) or $params['key'] = $this->hkdf(self::$key, 'sha512', null, self::strlen(self::$key), 'encryption');
            ...
            if (isset($params['hmac_digest'])) {
                  isset($params['hmac_key']) or $params['hmac_key'] = $this->hkdf(self::$key, 'sha512', null, null, 'authentication');
      ...
      protected function _get_params($params) {
            if (empty($params)) {
                  return isset($this->_cipher, $this->_mode, self::$key, $this->_handle) ? array(
                        'handle' => $this->_handle,
                        'cipher' => $this->_cipher,
                        'mode' => $this->_mode,
                        'key' => null,
