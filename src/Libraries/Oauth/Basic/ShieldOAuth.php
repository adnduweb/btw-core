...
class ShieldOAuth
{
    ...
    public function makeOAuthButton(string $forPage = 'login'): string
    {
        ...
        if (service('settings')->get('ShieldOAuthConfig.allow_login_github') == true) {
            $Button .= '<a hx-boost="false" href=' . base_url('oauth/github') . " class='bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]' aria-current='page'>
