...
namespace Btw\Core\Libraries\Oauth;

use Btw\Core\Libraries\Oauth\Basic\AbstractOAuth;
...
class GoogleOAuth extends AbstractOAuth
{
    ...
    public function __construct(string $token = '')
    {
        ...
        $this->client_id     = setting('ShieldOAuthConfig.google_client_id');
        $this->client_secret = setting('ShieldOAuthConfig.google_client_secret');
    }
