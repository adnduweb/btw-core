<div x-data="{ <?= $params['type']; ?>: false  }" x-show="<?= $params['type']; ?>" class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div id="<?= $params['type']; ?>" x-show="<?= $params['type']; ?>" x-on:closemodal.window="<?= $params['type']; ?> = false" x-on:openmodal<?= $params['name']; ?>.window="<?= $params['type']; ?> = true" class="fixed inset-0 z-50 overflow-y-auto px-5 my-5" aria-labelledby="modal-title" role="dialog" aria-modal="true" hx-target="this">
