<div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow overflow-y-auto relative">
    <table class="hidden w-full" data-kt-users-table-row="selected">
        <tr class=" dark:bg-gray-700  bg-indigo-50 dark:bg-gray-800  dark:hover:bg-gray-600 hover:bg-slate-50 dark:text-white">
            <td class="px-6 py-4 bg-indigo-50 dark:bg-gray-800 whitespace-nowrap text-sm font-medium dark:text-white" colspan="10">
                <div class="selected">
                    <span>
                        You are currently selecting all <strong><span class="me-2" data-kt-users-table-select="selected_count"></span></strong> rows
                    </span>
    ...
    <table class="border-collapse table-auto w-full whitespace-no-wrap  bg-white dark:bg-gray-800 table-striped relative" id="kt_table_users" hx-boost="true">
        <thead>
