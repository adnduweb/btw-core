<div id="general" class="shadow sm:rounded-md sm:overflow-hidden" hx-trigger="load">
    <div class="px-4 py-5 bg-white dark:bg-gray-800 space-y-6 sm:p-6">
        ...
        <h3 class="text-base font-medium leading-6 text-gray-900 dark:text-gray-200">History</h3>
                        ...
                        <tr class="relative dark:hover:bg-gray-600 hover:bg-slate-50 ">
                            ...
                            <td class="border-dashed border-t border-gray-300 text-gray-700 px-6 py-3 dark:text-gray-200">
                                <?php if ($login->success) : ?>
                                    <span class="text-xs font-semibold inline-block py-1 px-2 rounded-full text-green-600 bg-green-200 uppercase last:mr-0 mr-1">Success</span>
                                <?php else : ?>
                                    <span class="text-xs font-semibold inline-block py-1 px-2 rounded-full text-pink-600 bg-pink-200 uppercase last:mr-0 mr-1">Failed</span>
                                <?php endif ?>
                            </td>
                        </tr>
                    <?php endforeach ?>
