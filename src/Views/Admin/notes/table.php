<div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow overflow-y-auto relative">
    ...
    <table class="border-collapse responsive table-auto w-full whitespace-no-wrap  bg-white dark:bg-gray-800 table-striped relative kt-datatable" id="kt_table_notes" hx-boost="true">
        <thead>
