        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-slate-100">
            ...
            <x-admin-box>
                <form action="/admin/settings/general" method="post">
                    ...
                    <h6 class="text-slate-400 text-sm mt-3 mb-6 font-bold uppercase">General</h6>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-4">
                            <div class="form-check py-3 px-5">
                                <input class="form-check-input" type="checkbox" name="siteOnline" value="1" <?php if (old('siteOnline', setting('Site.siteOnline') ?? false)) : ?> checked <?php endif ?> />
                    ...
                    <h6 class="text-slate-400 text-sm mt-3 mb-6 font-bold uppercase">Date and Time Settings</h6>
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <select name="timezoneArea" class="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" hx-get="/<?= ADMIN_AREA ?>/settings/timezones" hx-target="#timezone" hx-include="[name='timezoneArea']">
                    ...
                    <div class="row mt-4">
                        <div class="col-12 col-sm-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="dateFormat" value="m/d/Y" <?php if (old('dateFormat', $dateFormat) === 'm/d/Y') : ?> checked <?php endif ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="dateFormat" value="d/m/Y" <?php if (old('dateFormat', $dateFormat) === 'd/m/Y') : ?> checked <?php endif ?>>
                                <label class="form-check-label" for="dateFormat">
                                    dd/mm/yyyy
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="dateFormat" value="Y-m-d" <?php if (old('dateFormat', $dateFormat) === 'Y-m-d') : ?> checked <?php endif ?>>
                                <label class="form-check-label" for="dateFormat">
                                    yyyy-mm-dd
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="dateFormat" value="M j, Y" <?php if (old('dateFormat', $dateFormat) === 'M j, Y') : ?> checked <?php endif ?>>
                                <label class="form-check-label" for="dateFormat">
                                    mmm dd, yyyy
                                </label>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12 col-sm-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="timeFormat" value="g:i A" <?php if (old('timeFormat', $timeFormat) === 'g:i A') : ?> checked <?php endif ?>>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="timeFormat" value="H:i" <?php if (old('timeFormat', $timeFormat) === 'H:i') : ?> checked <?php endif ?>>
                                    <label class="form-check-label" for="timeFormat">
                                        24 hour
                                    </label>
                                </div>
