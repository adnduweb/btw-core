    ...
    <div class="flex-1 pr-4">
        ...
        <div class="relative md:w-1/3">
            <input type="text" data-kt-datatable-filter="search"
                class="w-full pl-10 pr-4 py-2 border-gray-300 dark:border-transparent rounded-lg shadow focus:outline-none focus:shadow-outline text-gray-600 dark:text-gray-400 dark:bg-gray-700 font-medium"
                placeholder="<?= lang('Btw.search'); ?>" aria-label="Search" aria-describedby="button-addon1" />
                ...
                <div class="shadow rounded-lg flex" x-data="{ open: false }">
                    <div class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
                            ...
                            class="z-40 absolute top-0 right-0 w-40 bg-white dark:bg-gray-700 dark:text-gray-300 rounded-lg shadow-lg mt-12 -mr-1 block py-1 overflow-hidden"
                            style="display: none;">
                            ...
                            <?php foreach ($actions as $action): ?>
                                ...
                                switch ($action) {
                                    case 'delete':
                                        ?>
                                        <div
                                            class="flex flex-col justify-between items-center text-truncate hover:bg-gray-100 dark:hover:bg-gray-600 px-4 py-2">
