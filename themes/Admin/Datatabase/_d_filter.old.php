    ...
    <div class="flex">
        ...
        <div class="w-full shadow p-5 mb-5 rounded-lg bg-white">
            ...
            <?php if (isset($fieldsFilter['dateTimePicker']) && $fieldsFilter['dateTimePicker'] == true): ?>
                ...
                <!-- <inputdaterangepicker class="" name="" id="kt_daterangepicker_2"  /> -->
                    ...
                    <div class="flex items-center" x-data="initDatePickerRange()" x-init="init()">
                        <div class="relative">
                            ...
                            <input id="daterange" x-ref="picker" autocomplete="off" datepicker-format="dd/mm/yyyy"
                                data-kt-datatable-filter-input data-kt-datatable-filter
                                data-kt-datatable-filter-date="start" name="daterange" type="text"
                        ...
                        <div class="relative">
                            ...
                            <input autocomplete="off" datepicker-format="dd/mm/yyyy" data-kt-datatable-filter-input
                                data-kt-datatable-filter data-kt-datatable-filter-date="end" name="end" type="text"
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
                        ...
                        if (is_array($custom)) {
                            ...
                            foreach ($custom as $field):
                                switch ($field['key']) {
                                    case 'select':
                                        echo view_cell('Btw\Core\Cells\SelectCell::renderList', [
                                            'label' => false,
                                            'name' => $field['name'],
